...
use Lof\Seo\Model\Config\Source\PriceValidUntil;
...
class SeoRender
{
    ...
    public function showProductStructuredData()
    {
        if ($currentProduct = $this->getProduct()) {
            try {
                ...
                if (!$this->_moduleManager->isEnabled('Lof_Shopbybrand')) {
                ...
                $objectStructuredData = new DataObject(['lofdata' => $productStructuredData]);
                $this->_eventManager->dispatch(
                    'lof_seo_product_structured_data',
                ...
                return $this->helperData->createStructuredData(
                    $productStructuredData,
                    '<!-- Product Structured Data by Lof SEO-->'
                );
            } catch (Exception $e) {
    ...
    public function showBusinessStructuredData()
    {
        ...
        return $this->helperData->createStructuredData(
            $businessStructuredData,
            '<!-- Business Structured Data by Lof SEO-->'
        );
    }
    ...
    public function showSiteLinksStructuredData()
    {
        ...
        return $this->helperData->createStructuredData(
            $siteLinksStructureData,
            '<!-- Sitelinks Searchbox Structured Data by Lof SEO-->'
        );
    }
